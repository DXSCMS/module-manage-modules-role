...
$dir = "$link/".$_GET['m']."/data/module.head.php";
$dir_lbl = "$link/<strong>".$_GET['m']."</strong>/data/module.head.php";
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><?php echo $_LANG["edit-head-mod"];?></strong></div>
			<div class="panel-body">
				...
				?>
				<form name="fedithead" method="post" action="<?php echo $action;?>">
					<input type="hidden" name="type" value="modhead" />
