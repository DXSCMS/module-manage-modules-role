...
$dir = "$link/".$_GET['m']."/lang/".$_GET['lang'].".php";
?>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><?php echo $_LANG["edit-lang-mod"];?></strong></div>
			<div class="panel-body">
				...
				?>
				<form name="feditlng" method="post" action="<?php echo $action;?>" id="feditlng">
					...
					<label class="btn btn-sm btn-info"><i class="fa fa-language"></i> <strong><?php echo $_GET["lang"];?></strong>.php</label>												
