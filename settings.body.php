...
$dir = "$link/".$_GET['m']."/data/settings.php";
$dir_lbl = "$link/<strong>".$_GET['m']."</strong>/data/settings.php";
?>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><?php echo $_LANG["edit-settings-mod"];?></strong></div>
			<div class="panel-body">
				...
				?>
				<form name="feditsettings" method="post" action="<?php echo $action;?>">
					<input type="hidden" name="type" value="settings" />
					<input type="hidden" name="module" value="<?php echo $_GET["m"];?>" />
					
					<label class="btn btn-sm btn-default"><i class="fa fa-suitcase"></i> <?php echo $_GET['m'];?></label>
